...
export default class EventComponent extends Component {
    ...
    fetch(
      ...
      .then(responseJson => {
        ...
        try {
          ...
          alert(`No events with ${keyword} at the moment!`);
        }
      })
      .catch(error => {
        console.error(error);
  ...
  _priceRangesVerify(item) {
    try {
      ...
      if (min == max) {
        return <Text>${min.toFixed(2)}</Text>;
      } else {
        return (
          <Text>
            Ticket Price: ${min.toFixed(2)} to ${max.toFixed(2)}
          </Text>
        );
      }
    } catch (e) {
      return <Text>Ticket Price: TBA</Text>;
    }
  }
              ...
              <TextInput
                ...
                onSubmitEditing={event => {
                  try {
                    ...
                    this.getData(
                      this.state.geohashLocation,
                      this.state.radiusValue,
                ...
                >
                  ...
                  >
                    <View>
                      ...
                      <Text>
                        Starting {item.dates.start.localDate}{" "}
